...
const Homenav = () => {
  ...
  return (
    <div  className="7self-stretch overflow-y-auto flex flex-col md:flex-row md:items-center items-start justify-start text-left text-base text-dwhite font-popins">
      ...
      <BsButton
         className="relative top-[calc(50%_-_20px)] left-[calc(47%_+_515.54px)] cursor-pointer"
        ...
        <BsButton
          className="absolute top-[calc(50%_-_20px)] left-[calc(49%_+_612.09px)] cursor-pointer"
          variant="outline-primary"
